<template>
    <div id="newTodo" class="bg-white dark:bg-blue-800 px-5 py-4 md:px-6 md:py-[17px] rounded-lg shadow-custom dark:shadow-custom-dark flex items-center gap-3 md:gap-5 focus-within:outline-auto">
